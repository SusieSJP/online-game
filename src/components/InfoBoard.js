        ...
        <div className={styles.CenterDiv}>
          <button className={styles.Button} onClick={() => {
            this.setState((prevState) => {
              return { showRoleIntro: !prevState.showRoleIntro };
            })
          }}>{this.state.showRoleIntro ? "关闭" : "显示"}角色技能信息</button>
          {
            this.state.showRoleIntro &&
            <RoleIntro roles={this.props.roles} />
          }

          {
            this.props.curRound > 0 &&
